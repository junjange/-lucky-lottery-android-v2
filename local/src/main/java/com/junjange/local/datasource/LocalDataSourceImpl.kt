...
internal class LocalDataSourceImpl @Inject constructor(
    ...
    override suspend fun saveJwtToken(jwtTokenEntity: JwtTokenEntity): Result<Unit> = runCatching {
    ...
    override suspend fun saveIdToken(idToken: String): Result<Unit> = runCatching {
        sharedPreferences.edit {
    ...
    override suspend fun deleteLocalData(): Result<Unit> = runCatching {
        sharedPreferences.edit {
            clear()
            commit()
        }
